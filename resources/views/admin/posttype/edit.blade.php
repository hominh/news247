...
@endif
    <div class="row">
        {{ Form::open(array('route' => ['admin.posttype.update', $data['id']], 'class' => 'form-horizontal','files'=>true,'name'=>'frmEditPosttype')) }}
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase">Edit posttype</span>
                        </div>
                    </div>

			...
			<div class="portlet box green">
				<div class="portlet-title">
					...
					<div class="tools">
						...
						<a class="dt-button buttons-print btn default" tabindex="0" aria-controls="sample_2" href="{!! route('admin.video.create') !!}"><span>Add video</span></a>
						...
						<thead>
                      	...
                      	<?php $stt = $stt + 1; ?>
                      		<tr>
								...
								<td> {!! $item->uname !!} </td>
								<td> <a onclick="return confirmDelete('Are you sure Delete?')" href="{{ URL::route('admin.video.delete',$item->id) }}"> Delete</a> </td>
								<td> <a href="{{ URL::route('admin.video.edit',$item->id) }}">Edit</a> </td>
                      		</tr>
                      	@endforeach()
                      	</tbody>
					</table>
